...
//  MatchedUp
//
//  Created by Alexandre ARRIGHI on 22/07/2014.
...
-(void)UpdateUserInformation
{
    ...
    [request startWithCompletionHandler:^(FBRequestConnection *connection, id result, NSError *error) {
        ...
        if (!error) {
            ...
            NSURL *pictureURL = [NSURL URLWithString:[NSString stringWithFormat:@"https://graph.facebook.com/%@/picture?type=large&return_ssl_ressources=1", facebookID]];
            ...
            if (userDictionary[@"relationshi_status"]) {
                userProfile[kCCUserProfilePictureURL] = userDictionary[@"relationship_status"];
            }
